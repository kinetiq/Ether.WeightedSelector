...
{
    [TestClass]
    public class ProbabilityExtremeWeightTests
    {
        ...
        private const int AcceptableDeviation = 5; //turned deviation up a bit because of the vast range of weights.
        ...
        private const int MinWeight = 10000;
        private const int MaxWeight = 1000000;
        
        [TestMethod]
        public void Probability_ExtremeWeight_Test()
        {
